function [FWER_rep, edge_stats_rep, pvals_rep, cluster_stats_rep, ...
          ...
          pf_repetition_loop(i_rep, ids_sampled, switch_task_order, RepParams, UI)
    ...
    if RepParams.use_both_tasks 
        ...
        m_test = pf_paired_desing_extract_subset(rep_sub_ids, i_rep, ...
        ...
        m_test = pf_single_task_extract_subset(rep_sub_ids, i_rep, ...
                                               RepParams.brain_data, RepParams.task1, ...
