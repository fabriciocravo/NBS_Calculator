...
RepParams.task1_IDs_file=[RepParams.data_dir, RepParams.task1, RepParams.subIDs_suffix];
...
RepParams.task1_IDs=fileread(RepParams.task1_IDs_file);
RepParams.task1_IDs=strsplit(RepParams.task1_IDs,newline);

% This line deletes empty indices from the array!!!
RepParams.task1_IDs(strcmp('',RepParams.task1_IDs)) = [];
...
if RepParams.use_both_tasks % doing a paired sample test
    ...
    % get task2 IDs
    RepParams.task2_IDs_file=[RepParams.data_dir, RepParams.task2, RepParams.subIDs_suffix];
    RepParams.task2_IDs=fileread(RepParams.task2_IDs_file);
    RepParams.task2_IDs=strsplit(RepParams.task2_IDs,newline);
    % Delete empty indeces
    RepParams.task2_IDs(strcmp('', RepParams.task2_IDs)) = [];
    
    % compare task1 w task2
    fprintf(['Comparing subject IDs from from task1:\n(',RepParams.task1_IDs_file,')\n' ...
            'with IDs from task2:\n(',RepParams.task2_IDs_file,').\n']);
    [RepParams.subIDs, ~, ~] = intersect(RepParams.task1_IDs,RepParams.task2_IDs);
    RepParams.subIDs(strcmp('', RepParams.subIDs)) = [];
    ...
    fprintf(['Using subject IDs from from task1 (',RepParams.task1_IDs_file,').\n']);
    RepParams.task1_IDs(strcmp('',RepParams.task1_IDs)) = [];
